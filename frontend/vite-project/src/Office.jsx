...
const Office = (props) => {
    ...
    const [background, setBGI] = useState("/office.png")
    ...
    const checkKeyPress = useCallback((e) => {
        ...
        // }
        console.log(x, y)
        if (Math.max(Math.abs(x - 140), Math.abs(y - 612)) <= 40) {
    ...
    return (
        <>
            ...
            <div style={{ transform: `translate(60px, 350px)`, textAlign: "center" }}>
                    <b style={{color:"white"}}>School Head</b><br/>
                    <img style={{ height: "100px" }} src="/head.png" />
                </div>
